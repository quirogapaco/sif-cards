...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen dark:bg-[#09090b] bg-[#fafafa] dark:text-slate-300 text-slate-700 relative selection:bg-[#ddb225] selection:text-black overflow-x-hidden transition-colors duration-300">
