...
import peepsImage from '../../assets/peeps/all-peeps.png';
...
export const CrowdCanvas: React.FC<CrowdCanvasProps> = ({
  ...
  useEffect(() => {
    ...
    const resetPeep = ({ stage, peep }: { stage: any; peep: any }) => {
      ...
      const offsetY = 20 - 90 * gsap.parseEase('power2.in')(Math.random());
    ...
    img.onload = init;
    img.onerror = (err) => {
      console.error('Error al cargar la imagen local de CrowdCanvas:', err);
    };
    img.src = config.src;
